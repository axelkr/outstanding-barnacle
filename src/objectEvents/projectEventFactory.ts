...
export class ProjectEventFactory {
  public create(topic: string, name: string, stateModel: StateModel): ObjectEvent[] {
  ...
  public initializeProperty(topic: string, project: Project, propertyName: string, newValue: string): ObjectEvent {
  ...
  public updateProperty(topic: string, project: Project, propertyName: string, newValue: string): ObjectEvent {
